      ...
      <div className="relative flex items-center justify-center w-full h-full ">
        <div className="relative p-20 border-2 border-none rounded-full profileCard_container border-spacing-4 border-gray-400/50 animated-border">
          ...
          >
            ...
            <button className="profile_item right-[43px] -top-[6px] absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[20px] active:scale-95 hover:scale-95 transition-all duration-500">
              <img
                src={m_images[1].url}
                alt="img.png"
                className="w-[100px] h-[100px] transition-all duration-500 rounded-full z-[2] bg-white"
            ...
            <button className="profile_item bottom-8 -left-0 absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[20px] active:scale-95 hover:scale-95 transition-all duration-500">
              <img
                src={m_images[0].url}
                alt="img.png"
                className="w-[100px] h-[100px] transition-all duration-500 rounded-full z-[2] bg-white"
